...
class CreateUserCommand extends Command
{
    ...
    protected function configure(): void
    {
        $this
            ...
            ->addArgument('fullname', InputArgument::OPTIONAL, 'The full name of the new user')
            ->addOption('isAdmin', null, InputOption::VALUE_NONE, 'If set, the user is created as an administrator')
        ;
    }
